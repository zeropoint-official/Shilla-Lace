...
export function ParallaxCTA() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-[1] bg-gradient-to-t from-black/85 via-black/60 to-black/40" />
      <div className="grain-overlay absolute inset-0 z-[2] pointer-events-none" />

      <div
        ref={contentRef}
        className="relative z-[3] text-center px-5 md:px-10 max-w-2xl mx-auto"
      >
        ...
        <h2 className="font-heading text-[clamp(2rem,5vw,4rem)] italic text-white font-light leading-[1.1] mb-6 md:mb-8 drop-shadow-lg">
          Every Piece Tells
          <br />a Story
        </h2>
        ...
        <Link
          ...
          className="group relative inline-flex items-center justify-center h-13 px-12 bg-accent text-white text-[11px] tracking-[0.25em] uppercase overflow-hidden transition-all duration-500 hover:bg-accent-light shadow-lg"
        >
